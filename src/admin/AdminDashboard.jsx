...
function AdminDashboard() {
  ...
  const loadDashboardData = async () => {
    try {
      const [productsRes, usersRes, ordersRes, statsRes, allOrdersRes, allProductsRes] =
        await Promise.all([
          fetch(`${API_URL}/products?limit=1`),
          fetch(`${API_URL}/users?limit=1`, {
            headers: { Authorization: `Bearer ${token}` }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
        ...
        <div className="relative bg-white/10 backdrop-blur-lg p-8 rounded-2xl shadow-2xl w-full max-w-md border border-white/20">
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-slate-400">Dwarika E-commerce Admin Panel</p>
          </div>
        </div>
      </div>
    );
                    ...
                    <tbody>
                      {recentOrders && recentOrders.length > 0 ? (
                        recentOrders.map((order) => {
                          ...
                          return (
                            <tr key={order._id || order.orderNumber || Math.random()} className="border-b border-gray-100 hover:bg-gray-50 transition">
                              <td className="py-3 px-4">
                                <span className="font-medium text-gray-800">{order.orderNumber || 'N/A'}</span>
                              </td>
                              <td className="py-3 px-4">
                  ...
                  <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-300">
                    <div className="bg-gradient-to-r from-green-600 to-green-700 px-8 py-6 text-white">
                      <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => setShowUserForm(false)} className="bg-white/20 hover:bg-white/30 p-2 rounded-lg transition-colors">
                          <XIcon size={24} />
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-300">
                    <div className="bg-gradient-to-r from-pink-600 to-pink-700 px-8 py-6 text-white">
                      <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => setShowBannerForm(false)} className="bg-white/20 hover:bg-white/30 p-2 rounded-lg transition-colors">
                          <XIcon size={24} />
                        </button>
                      </div>
                    </div>
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between items-center">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button onClick={() => deleteBanner(banner._id)} className="text-red-600 hover:text-red-800">
                              <Trash2 size={18} />
                            </button>
                          </div>
                        </div>
